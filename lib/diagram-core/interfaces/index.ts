...
import { DiagramConfig, DiagramElement, DiagramLink, DiagramData, DiagramEvent, DiagramEventType } from '../../types';
...
export interface IDataManager {
  ...
  deserialize(data: any, graph: dia.Graph, shapeFactory?: IShapeFactory, linkFactory?: ILinkFactory): void;
  deserializeCustomFormat(data: DiagramData, graph: dia.Graph, shapeFactory: IShapeFactory, linkFactory: ILinkFactory): void;
  validateData(data: DiagramData): boolean;
  exportToJSON(graph: dia.Graph, pretty?: boolean): string;
  importFromJSON(jsonString: string, graph: dia.Graph, shapeFactory?: IShapeFactory, linkFactory?: ILinkFactory): void;
}
...
export interface IGraphManager {
  addElement(graph: dia.Graph, elementConfig: Partial<DiagramElement>, shapeFactory: IShapeFactory): string;
  ...
  createGroup(graph: dia.Graph, elementIds: string[], groupConfig?: Partial<DiagramElement>): string;
...
export interface IShapeFactory {
  ...
  createShapeWithPorts(type: string, config: Partial<DiagramElement>, portsConfig?: any): dia.Element;
}
